...
namespace ClinicManagement.Controllers
{
    public class ReportsController : Controller
    {
        ...
        public ActionResult PetAttandence(string token = null)
        {
            var petAttandences = _unitOfWork.Attandences.GetPetAttandences(token);
            return View("_AttandencePartial",petAttandences);
        }
