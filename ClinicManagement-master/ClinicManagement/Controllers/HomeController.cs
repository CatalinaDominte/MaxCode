...
namespace ClinicManagement.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public ActionResult TotalPets()
        {
            var pets = _context.Pets.ToList();
            return Json(pets.Count(), JsonRequestBehavior.AllowGet);
        }
        ...
        //Today's pets
        public ActionResult TodaysPets()
        {
            DateTime today = DateTime.Now.Date;
            var pets = _context.Pets.Where(p => p.DateTime >= today).ToList();
            return Json(pets.Count(), JsonRequestBehavior.AllowGet);
        }
        //Todays appointments
