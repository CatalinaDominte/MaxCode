...
namespace ClinicManagement.Persistence.Repositories
{
    public class AppointmentRepository : IAppointmentRepository
    {
        ...
        /// <summary>
        /// Get appointments for single pet
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        public IEnumerable<Appointment> GetAppointmentWithPet(int id)
        {
            return _context.Appointments
                .Where(p => p.PetId == id)
                .Include(p => p.Pet)
        ...
        {
            var result = _context.Appointments.Include(p => p.Pet).Include(d => d.Doctor).AsQueryable();
            if (searchModel != null)
            {
        ...
        /// <summary>
        /// Get number of appointments for defined pet
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        public int CountAppointments(int id)
        {
            return _context.Appointments.Count(a => a.PetId == id);
        }
